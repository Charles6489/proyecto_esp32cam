...
String getReadings(){
  ...
  temperature = (analogRead(14)* 285.0) / 1024.0;
  //temperature = bme.readTempF();
  humidity = (analogRead(15)* 285.0) / 1024.0;
...
void handleNewMessages(int numNewMessages){
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    //  bot.sendMessage(chatId, readings, "");
     ...
     if (text == "/video"){
        Serial.print("Camera Ready! Use 'http://192.168.1.141");
        Serial.println("'to connect");
        String welcome1 = "http://192.168.1.141";
        bot.sendMessage(chatId, welcome1, "Markdown");
    }
      if (text == "/imagenes"){
        Serial.print("Camera Ready! Use 'http://192.168.1.141");
        Serial.println("'to connect");
        String welcome1 = "http://34.125.125.114/gallery.php";
        bot.sendMessage(chatId, welcome1, "Markdown");
    }
    ...
    if (text == "/inicio"){
      ...
      welcome += "You'll receive a foto whenever motion is detected.\n";
    ...
    if (text == "/start"){
      ...
      welcome += "/alarma :Activar alarma\n";
      welcome += "/parar : Apagar alarma\n";
      welcome += "/imagenes : Imagenes Guardadas\n";
      welcome += "/llamar : Llamada telefono IP\n";
      welcome += "/temperatura : Leer temperatura\n";
